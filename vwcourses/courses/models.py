...
class Course(models.Model):
  ...
  def get_absolute_url(self):
    return ('courses:details', (), {'course_slug': self.slug})
...
class Material(models.Model):
  ...
  lesson = models.ForeignKey(Lesson, related_name='materials')
...
def post_save_announcement(instance, created, **kwargs):
  if created:
    ...
    for enrollment in enrollments:
      ...
      send_email_template(subject, template, context, recipient_list)


models.signals.post_save.connect(post_save_announcement, sender=Announcement, dispatch_uid='post_save_ennouncement')
